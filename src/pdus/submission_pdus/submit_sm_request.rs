...
impl SubmitSmRequest {
    ...
    pub fn new(
        ...
        Self {
            ...
            registered_delivery: 1, // Default: Request delivery receipt
    ...
    pub fn encode(&self, writer: &mut impl Write) -> Result<(), PduError> {
        ...
        write_c_string(&mut body, &self.schedule_delivery_time)?;
        write_c_string(&mut body, &self.validity_period)?;
        ...
        body.write_all(&[self.short_message.len() as u8])?;
        body.write_all(&self.short_message)?;
